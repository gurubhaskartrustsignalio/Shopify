...
export default function HomePage() {
    ...
    // const gitHubUrl = "https://jsonplaceholder.typicode.com/posts";


    let api = "205c75ee-12f3-4b0b-963d-8e528556f8c7";
    const gitHubUrl = `https://dev-api.trustsignal.io/v1/createuserotp?api_key=${api}`;
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        setUserData(await createuserotpWithFetch());
        formValues.otp = userData.phone;
